...
\todo{soll ich hier wirklich alle formeln und two-sample alternativen nennen?}
discrete versionen: \cite{Flannery:NumericalrecipesFORTRAN}
\begin{itemize}
...
%The empirical distribution is being subsampled to a be \num{10} times as large as the sample distribution to improve computational performance.
