...
gravity
hiearchy problem, planck scale
extra dimensions
ADD, RS
non-thermal
quantized mass 
decay before thermalization in pairs of particles
LFV options possible too
here: benchmark using QBH to \Pe + \Pmu.

\subsubsection{Semi-Classical Black Holes}
classical (=astronomy): no extra dimensions
hawking radiation
thermal
...
\todo{HERE}
Here: branching ratio $\PWprime \to \Pqt \Pqb$ set to 1 (as in AN2016\_480\_v2), corresponds to $M_{W'_R} < M_{\nu_R}$ scenario\cite{CMS:CMS-PAS-B2G-17-010}.
