...
So far, \ac{SUSY} models containing the notion of $R$-parity have been tightly constrained. Thus, some analyses focus on $R$-parity violating theories, which stabilize the proton in other ways.
