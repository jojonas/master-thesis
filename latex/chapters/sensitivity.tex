...
\begin{figure}[p]
    \centering
    \includegraphics[height=6cm]{results/phatplots/bJets/VALIDATION/exclusive/SumPt/ChiSq_uniform_results}
    \includegraphics[height=6cm]{results/phatplots/bJets/VALIDATION/exclusive/SumPt/KS_uniform_results}
...
\begin{figure}[p]
    \centering
    \includegraphics[height=6cm]{results/phatplots_uni/bJets/VALIDATION/exclusive/SumPt/ChiSq_uniform_results}
    \includegraphics[height=6cm]{results/phatplots_uni/bJets/VALIDATION/exclusive/SumPt/KS_uniform_results} \\
    \includegraphics[height=6cm]{results/phatplots_uni/bJets/BH_DEMO/exclusive/SumPt/ChiSq_uniform_results}
    \includegraphics[height=6cm]{results/phatplots_uni/bJets/BH_DEMO/exclusive/SumPt/KS_uniform_results}
